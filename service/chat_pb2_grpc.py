...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateNewUser = channel.unary_unary(
                '/ChatService/CreateNewUser',
                request_serializer=service_dot_chat__pb2.User.SerializeToString,
                response_deserializer=service_dot_chat__pb2.User.FromString,
                )
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'CreateNewUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=service_dot_chat__pb2.User.FromString,
                    response_serializer=service_dot_chat__pb2.User.SerializeToString,
            ),
    }
...
class ChatService(object):
    ...
    def CreateNewUser(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/ChatService/CreateNewUser',
            service_dot_chat__pb2.User.SerializeToString,
            service_dot_chat__pb2.User.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
